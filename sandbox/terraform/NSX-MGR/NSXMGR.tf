...
resource "vsphere_virtual_machine" "vmFromLocalOvf" {
  ...
  vapp {
  properties = {
      "guestinfo.hostname" = "babylon5.lab.travellingtechie.com",
      "guestinfo.ipaddress" = "10.1.60.51",
      "guestinfo.netmask" = "255.255.255.0",
      "guestinfo.gateway" = "10.1.60.1",
      "guestinfo.dns" = "10.1.10.5",
      "guestinfo.domain" = "lab.travellingtechie.com",
      "guestinfo.ntp" = "pool.ntp.org",
      "guestinfo.password" = "0verDdog&FOX",
      "guestinfo.ssh" = "True"
      }
  }
  lifecycle {
